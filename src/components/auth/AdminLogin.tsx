...
export const AdminLogin: React.FC<AdminLoginProps> = ({
  ...
  const { adminLogin, storeSettings, navigate, setActiveView } = useStore();
  ...
  const handleGoogleAdminLogin = async () => {
    try {
      ...
      if (user && user.email) {
        // Only authorized admin ID is skgsurajshahu317@gmail.com
        const isAuthorized = user.email.toLowerCase() === 'skgsurajshahu317@gmail.com';
        ...
        setErrorMessage(`Account ${user.email} is not authorized. Only admin login ID is skgsurajshahu317@gmail.com.`);
      }
    } catch (err: any) {
      if (
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-neutral-100 flex flex-col justify-center items-center p-4 sm:p-6 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md relative z-10 space-y-6">
        ...
        <div className="text-center space-y-3">
          ...
          <div className="flex items-center justify-center gap-2.5">
            ...
            <h1 className="text-2xl font-black uppercase tracking-tight text-white">
              RIDEX MOTO - Admin Portal Login
            </h1>
          </div>
          <p className="text-xs text-neutral-400 max-w-xs mx-auto">
            Restricted operations access for inventory control, fulfillment, analytics, and store management.
          </p>
        </div>

        {/* Access Denied Warning Banner */}
        {errorMessage && (
          <div className="p-4 rounded-xl bg-red-950/70 border border-red-800/80 text-red-200 text-xs flex items-start gap-3 shadow-lg shadow-red-950/30 animate-fade-in">
        ...
        {/* Success Alert */}
        {successMessage && (
          <div className="p-4 rounded-xl bg-emerald-950/70 border border-emerald-800/80 text-emerald-200 text-xs flex items-center gap-3 shadow-lg shadow-emerald-950/30 animate-fade-in">
        ...
        <div className="bg-neutral-900/90 border border-neutral-800 rounded-2xl p-6 sm:p-8 shadow-2xl backdrop-blur-sm space-y-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] text-neutral-500">2FA Protected</span>
              </div>
              <div className="relative">
                <input
          ...
          {/* Quick Helper Button: Auto-fill Admin */}
          <div className="pt-4 border-t border-neutral-800/80 space-y-3">
            ...
            >
              ...
              <span>{isLoggingIn ? 'Verifying with Google...' : 'Sign In with Google Admin (skgsurajshahu317@gmail.com)'}</span>
            </button>
            ...
            <div className="p-3 rounded-xl bg-neutral-950 border border-neutral-800/80 text-[11px] text-neutral-400 flex items-center justify-between">
              <div>
                <span className="text-neutral-300 font-semibold block">Authorized Master Administrator:</span>
